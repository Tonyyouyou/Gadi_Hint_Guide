...
Before final novelty clearance, candidate-independent environment/data setup is permitted only through campaign.py external-submit within its small discovery-infrastructure cap. Environments must be assembled in PBS jobfs and published as one immutable .sqsh under /g/data/wa66/Xiangyu/enviroment_cache. Datasets must be downloaded/expanded in PBS jobfs and published as packed objects under /g/data/wa66/Xiangyu/Data. Never publish expanded dependency trees, dataset trees, caches, or model snapshots to persistent storage.
